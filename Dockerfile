...
# Tenta ate 3x com retry (cobre race condition entre replicas e DB ainda iniciando)
CMD ["sh", "-c", "for i in 1 2 3; do alembic upgrade head && break || sleep 3; done; uvicorn app.main:app --host 0.0.0.0 --port 8000 --workers 2"]
